 ...
 * @return {function}
 */
function keyCodeListener(arrayElems = null, content = null) { // eslint-disable-line
    ...
    if (content.className === "figure-container") {
        document
            .querySelector("div.previous")
            .addEventListener("click", previous);
        document.querySelector("div.next").addEventListener("click", next);
    }
    ...
    function closeDialog() {
        ...
        if (
            ...
            content.className === "figure-container"
        ) {
    ...
    /**
     * répartie les fn appropriés selon les events
     * @param {*} event
     */
    ...
    function enter() {
        ...
        if (location.pathname === "/" || location.pathname === "/index.html") {
            ...
            content.classList[0] === "album" &&
            location.pathname === "/photographer.html"
        ) {
            const lightBoxFigContainer = document.querySelectorAll(
